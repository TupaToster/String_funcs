...
string.exe: main.o fputs.o strlen.o strcpy.o strcat.o fgets.o strdup.o
	$(CC) $(CFLAGS) main.o strcpy.o strlen.o fputs.o strcat.o fgets.o strdup.o -o string.exe
